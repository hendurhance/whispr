...
import PrivacyCard from '@/components/molecules/PrivacyCard';
import SectionTitle from '@/components/molecules/SectionTitle';
import PhoneMockup from '@/components/atoms/PhoneMockup';
import DashboardView from '../Shared/DashboardView';
import ProfileView from '../Shared/ProfileView';
import FloatingShapes, { Shape } from '@/components/molecules/FloatingShapes';
import IconButton from '@/components/atoms/IconButton';
import FloatingMessagesContainer from '@/components/molecules/FloatingMessagesContainer';
