        ...
        <div className="space-y-8 text-text-normal">
          ...
          <section>
            ...
            <p className="mt-4 mb-4">
              Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, some information may be retained in our files to prevent fraud, troubleshoot problems, assist with any investigations, enforce our <Link href={termsLink} className="text-accent-blue hover:underline">Terms of Use</Link> and/or comply with legal requirements.
            </p>
