            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="space-y-8 text-text-normal">
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            Your privacy is important to us. Our <Link href={privacyLink} className="text-accent-blue hover:underline">Privacy Policy</Link> explains how we collect, use, and protect your personal information. By using our service, you consent to our collection and use of personal data as explained in our Privacy Policy.
                        </p>
                    </section>
